...
namespace aero.aixm.schema._5_1_1.extensions.eur.adr
{
    ...
    public partial class ReferenceLocationTimeSliceType : aixm.v5_1_1.AbstractAIXMTimeSliceType
    {
        
        [System.Xml.Serialization.XmlElementAttribute("category", IsNullable=true)]
        public aixm.v5_1_1.CodeFlightDestinationType Category { get; set; }
        
        [System.Xml.Serialization.XmlElementAttribute("referenceLocationId", IsNullable=true)]
        public aixm.v5_1_1.TextNameType ReferenceLocationId { get; set; }
        ...
        public aixm.v5_1_1.AirspaceLayerPropertyType AirspaceLayer { get; set; }
