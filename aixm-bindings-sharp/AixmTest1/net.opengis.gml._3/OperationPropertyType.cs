...
namespace net.opengis.gml._3
{
    ...
    [System.Xml.Serialization.XmlTypeAttribute("OperationPropertyType", Namespace="http://www.opengis.net/gml/3.2")]
    ...
    public partial class OperationPropertyType
    {
        ...
        [System.Xml.Serialization.XmlElementAttribute("AbstractGeneralConversion", Type=typeof(net.opengis.gml._3.AbstractGeneralConversionType), Namespace="http://www.opengis.net/gml/3.2")]
        [System.Xml.Serialization.XmlElementAttribute("AbstractGeneralTransformation", Type=typeof(net.opengis.gml._3.AbstractGeneralTransformationType), Namespace="http://www.opengis.net/gml/3.2")]
        [System.Xml.Serialization.XmlElementAttribute("ConcatenatedOperation", Type=typeof(net.opengis.gml._3.ConcatenatedOperationType), Namespace="http://www.opengis.net/gml/3.2")]
        [System.Xml.Serialization.XmlElementAttribute("PassThroughOperation", Type=typeof(net.opengis.gml._3.PassThroughOperationType), Namespace="http://www.opengis.net/gml/3.2")]
        [System.Xml.Serialization.XmlElementAttribute("Conversion", Type=typeof(net.opengis.gml._3.ConversionType), Namespace="http://www.opengis.net/gml/3.2")]
        [System.Xml.Serialization.XmlElementAttribute("Transformation", Type=typeof(net.opengis.gml._3.TransformationType), Namespace="http://www.opengis.net/gml/3.2")]
        [System.Xml.Serialization.XmlElementAttribute("AbstractOperation")]
        public net.opengis.gml._3.AbstractCoordinateOperationType AbstractOperation { get; set; }
