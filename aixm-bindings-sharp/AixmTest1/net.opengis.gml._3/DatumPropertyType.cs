...
namespace net.opengis.gml._3
{
    ...
    /// <summary>
    /// <para>gml:DatumPropertyType is a property type for association roles to a datum, either referencing or containing the definition of that datum.</para>
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("XmlSchemaClassGenerator", "1.0.0.0")]
    [System.SerializableAttribute()]
    [System.Xml.Serialization.XmlTypeAttribute("DatumPropertyType", Namespace="http://www.opengis.net/gml/3.2")]
    ...
    public partial class DatumPropertyType
    {
        ...
        [System.Xml.Serialization.XmlElementAttribute("GeodeticDatum", Type=typeof(GeodeticDatumType), Namespace="http://www.opengis.net/gml/3.2")]
        [System.Xml.Serialization.XmlElementAttribute("EngineeringDatum", Type=typeof(EngineeringDatumType), Namespace="http://www.opengis.net/gml/3.2")]
        [System.Xml.Serialization.XmlElementAttribute("ImageDatum", Type=typeof(ImageDatumType), Namespace="http://www.opengis.net/gml/3.2")]
        [System.Xml.Serialization.XmlElementAttribute("VerticalDatum", Type=typeof(VerticalDatumType), Namespace="http://www.opengis.net/gml/3.2")]
        [System.Xml.Serialization.XmlElementAttribute("TemporalDatum", Type=typeof(TemporalDatumType), Namespace="http://www.opengis.net/gml/3.2")]
        [System.Xml.Serialization.XmlElementAttribute("AbstractDatum")]
