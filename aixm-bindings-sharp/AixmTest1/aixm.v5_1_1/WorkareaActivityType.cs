...
namespace aixm.v5_1_1
{
    ...
    [System.Xml.Serialization.XmlTypeAttribute("WorkareaActivityType", Namespace="http://www.aixm.aero/schema/5.1.1")]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlRootAttribute("WorkareaActivity", Namespace="http://www.aixm.aero/schema/5.1.1")]
    public partial class WorkareaActivityType : AbstractPropertiesWithScheduleType
    {
        ...
        /// <summary>
        /// <para xml:lang="de">Initialisiert eine neue Instanz der <see cref="WorkareaActivityType" /> Klasse.</para>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="WorkareaActivityType" /> class.</para>
        /// </summary>
        public WorkareaActivityType()
        {
            ...
            this._extension = new System.Collections.ObjectModel.Collection<WorkareaActivityTypeExtension>();
        }
        ...
        [System.Xml.Serialization.XmlElementAttribute("isActive", IsNullable=true)]
        public aixm.v5_1_1.CodeYesNoType IsActive { get; set; }
        
        [System.Xml.Serialization.XmlIgnoreAttribute()]
        private System.Collections.ObjectModel.Collection<WorkareaActivityTypeExtension> _extension;
        
        [System.Xml.Serialization.XmlElementAttribute("extension")]
        public System.Collections.ObjectModel.Collection<WorkareaActivityTypeExtension> Extension
        {
            get
            {
