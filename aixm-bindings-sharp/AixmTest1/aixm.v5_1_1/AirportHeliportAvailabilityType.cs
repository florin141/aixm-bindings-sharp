...
namespace aixm.v5_1_1
{
    ...
    [System.Xml.Serialization.XmlTypeAttribute("AirportHeliportAvailabilityType", Namespace="http://www.aixm.aero/schema/5.1.1")]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlRootAttribute("AirportHeliportAvailability", Namespace="http://www.aixm.aero/schema/5.1.1")]
    public partial class AirportHeliportAvailabilityType : AbstractPropertiesWithScheduleType
    {
        ...
        /// <summary>
        /// <para xml:lang="de">Initialisiert eine neue Instanz der <see cref="AirportHeliportAvailabilityType" /> Klasse.</para>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="AirportHeliportAvailabilityType" /> class.</para>
        /// </summary>
        public AirportHeliportAvailabilityType()
        {
            ...
            this._usage = new System.Collections.ObjectModel.Collection<AirportHeliportUsagePropertyType>();
            this._extension = new System.Collections.ObjectModel.Collection<AirportHeliportAvailabilityTypeExtension>();
        }
        ...
        public aixm.v5_1_1.CodeStatusAirportType OperationalStatus { get; set; }
        
        [System.Xml.Serialization.XmlElementAttribute("warning", IsNullable=true)]
        public aixm.v5_1_1.CodeAirportWarningType Warning { get; set; }
        
        [System.Xml.Serialization.XmlIgnoreAttribute()]
        private System.Collections.ObjectModel.Collection<AirportHeliportUsagePropertyType> _usage;
        
        [System.Xml.Serialization.XmlElementAttribute("usage", IsNullable=true)]
        public System.Collections.ObjectModel.Collection<AirportHeliportUsagePropertyType> Usage
        {
            get
            {
                return this._usage;
        ...
        /// <summary>
        /// <para xml:lang="de">Ruft einen Wert ab, der angibt, ob die Usage-Collection leer ist.</para>
        /// <para xml:lang="en">Gets a value indicating whether the Usage collection is empty.</para>
        /// </summary>
        [System.Xml.Serialization.XmlIgnoreAttribute()]
        ...
        [System.Xml.Serialization.XmlIgnoreAttribute()]
        private System.Collections.ObjectModel.Collection<AirportHeliportAvailabilityTypeExtension> _extension;
        
        [System.Xml.Serialization.XmlElementAttribute("extension")]
        public System.Collections.ObjectModel.Collection<AirportHeliportAvailabilityTypeExtension> Extension
        {
            get
            {
