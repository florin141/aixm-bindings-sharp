...
namespace aixm.v5_1_1
{
    ...
    [System.Xml.Serialization.XmlTypeAttribute("TouchDownLiftOffSafeAreaTimeSliceType", Namespace="http://www.aixm.aero/schema/5.1.1")]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlRootAttribute("TouchDownLiftOffSafeAreaTimeSlice", Namespace="http://www.aixm.aero/schema/5.1.1")]
    public partial class TouchDownLiftOffSafeAreaTimeSliceType : aixm.v5_1_1.AbstractAIXMTimeSliceType
    {
        ...
        /// <summary>
        /// <para xml:lang="de">Initialisiert eine neue Instanz der <see cref="TouchDownLiftOffSafeAreaTimeSliceType" /> Klasse.</para>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="TouchDownLiftOffSafeAreaTimeSliceType" /> class.</para>
        /// </summary>
        public TouchDownLiftOffSafeAreaTimeSliceType()
        {
            this._annotation = new System.Collections.ObjectModel.Collection<NotePropertyType>();
            this._extension = new System.Collections.ObjectModel.Collection<TouchDownLiftOffSafeAreaTimeSliceTypeExtension>();
        }
        
        [System.Xml.Serialization.XmlElementAttribute("protectedTouchDownLiftOff", IsNullable=true)]
        public TouchDownLiftOffPropertyType ProtectedTouchDownLiftOff { get; set; }
        
        [System.Xml.Serialization.XmlIgnoreAttribute()]
        private System.Collections.ObjectModel.Collection<TouchDownLiftOffSafeAreaTimeSliceTypeExtension> _extension;
        
        [System.Xml.Serialization.XmlElementAttribute("extension")]
        public System.Collections.ObjectModel.Collection<TouchDownLiftOffSafeAreaTimeSliceTypeExtension> Extension
        {
            get
            {
