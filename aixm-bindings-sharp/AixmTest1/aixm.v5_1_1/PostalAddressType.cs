...
namespace aixm.v5_1_1
{
    ...
    [System.Xml.Serialization.XmlTypeAttribute("PostalAddressType", Namespace="http://www.aixm.aero/schema/5.1.1")]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlRootAttribute("PostalAddress", Namespace="http://www.aixm.aero/schema/5.1.1")]
    public partial class PostalAddressType : AbstractPropertiesWithScheduleType
    {
        ...
        /// <summary>
        /// <para xml:lang="de">Initialisiert eine neue Instanz der <see cref="PostalAddressType" /> Klasse.</para>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="PostalAddressType" /> class.</para>
        /// </summary>
        public PostalAddressType()
        {
            ...
            this._extension = new System.Collections.ObjectModel.Collection<PostalAddressTypeExtension>();
        }
        ...
        [System.Xml.Serialization.XmlElementAttribute("deliveryPoint", IsNullable=true)]
        public aixm.v5_1_1.TextAddressType DeliveryPoint { get; set; }
        
        [System.Xml.Serialization.XmlElementAttribute("city", IsNullable=true)]
        public aixm.v5_1_1.TextNameType City { get; set; }
        
        [System.Xml.Serialization.XmlElementAttribute("administrativeArea", IsNullable=true)]
        public aixm.v5_1_1.TextNameType AdministrativeArea { get; set; }
        
        [System.Xml.Serialization.XmlElementAttribute("postalCode", IsNullable=true)]
        public aixm.v5_1_1.TextNameType PostalCode { get; set; }
        
        [System.Xml.Serialization.XmlElementAttribute("country", IsNullable=true)]
        public aixm.v5_1_1.TextNameType Country { get; set; }
        
        [System.Xml.Serialization.XmlIgnoreAttribute()]
        private System.Collections.ObjectModel.Collection<PostalAddressTypeExtension> _extension;
        
        [System.Xml.Serialization.XmlElementAttribute("extension")]
        public System.Collections.ObjectModel.Collection<PostalAddressTypeExtension> Extension
        {
            get
            {
