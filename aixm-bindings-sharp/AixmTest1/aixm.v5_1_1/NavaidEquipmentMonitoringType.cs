...
namespace aixm.v5_1_1
{
    ...
    [System.Xml.Serialization.XmlTypeAttribute("NavaidEquipmentMonitoringType", Namespace="http://www.aixm.aero/schema/5.1.1")]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlRootAttribute("NavaidEquipmentMonitoring", Namespace="http://www.aixm.aero/schema/5.1.1")]
    public partial class NavaidEquipmentMonitoringType : AbstractPropertiesWithScheduleType
    {
        ...
        /// <summary>
        /// <para xml:lang="de">Initialisiert eine neue Instanz der <see cref="NavaidEquipmentMonitoringType" /> Klasse.</para>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="NavaidEquipmentMonitoringType" /> class.</para>
        /// </summary>
        public NavaidEquipmentMonitoringType()
        {
            ...
            this._extension = new System.Collections.ObjectModel.Collection<NavaidEquipmentMonitoringTypeExtension>();
        }
        ...
        [System.Xml.Serialization.XmlElementAttribute("monitored", IsNullable=true)]
        public aixm.v5_1_1.CodeYesNoType Monitored { get; set; }
        
        [System.Xml.Serialization.XmlIgnoreAttribute()]
        private System.Collections.ObjectModel.Collection<NavaidEquipmentMonitoringTypeExtension> _extension;
        
        [System.Xml.Serialization.XmlElementAttribute("extension")]
        public System.Collections.ObjectModel.Collection<NavaidEquipmentMonitoringTypeExtension> Extension
        {
            get
            {
