...
namespace aixm.v5_1_1
{
    ...
    [System.Xml.Serialization.XmlTypeAttribute("VisualGlideSlopeIndicatorTimeSliceType", Namespace="http://www.aixm.aero/schema/5.1.1")]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlRootAttribute("VisualGlideSlopeIndicatorTimeSlice", Namespace="http://www.aixm.aero/schema/5.1.1")]
    public partial class VisualGlideSlopeIndicatorTimeSliceType : aixm.v5_1_1.AbstractAIXMTimeSliceType
    {
        ...
        /// <summary>
        /// <para xml:lang="de">Initialisiert eine neue Instanz der <see cref="VisualGlideSlopeIndicatorTimeSliceType" /> Klasse.</para>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="VisualGlideSlopeIndicatorTimeSliceType" /> class.</para>
        /// </summary>
        public VisualGlideSlopeIndicatorTimeSliceType()
        {
            ...
            this._extension = new System.Collections.ObjectModel.Collection<VisualGlideSlopeIndicatorTimeSliceTypeExtension>();
        }
        ...
        public aixm.v5_1_1.CodeVASISType Type { get; set; }
        
        [System.Xml.Serialization.XmlElementAttribute("position", IsNullable=true)]
        public aixm.v5_1_1.CodeSideType Position { get; set; }
        
        [System.Xml.Serialization.XmlElementAttribute("numberBox", IsNullable=true)]
        public aixm.v5_1_1.NoNumberType NumberBox { get; set; }
        
        [System.Xml.Serialization.XmlElementAttribute("portable", IsNullable=true)]
        public aixm.v5_1_1.CodeYesNoType Portable { get; set; }
        
        [System.Xml.Serialization.XmlElementAttribute("slopeAngle", IsNullable=true)]
        public aixm.v5_1_1.ValAngleType SlopeAngle { get; set; }
        
        [System.Xml.Serialization.XmlElementAttribute("minimumEyeHeightOverThreshold", IsNullable=true)]
        public aixm.v5_1_1.ValDistanceVerticalType MinimumEyeHeightOverThreshold { get; set; }
        
        [System.Xml.Serialization.XmlElementAttribute("runwayDirection", IsNullable=true)]
        public RunwayDirectionPropertyType RunwayDirection { get; set; }
        
        [System.Xml.Serialization.XmlIgnoreAttribute()]
        private System.Collections.ObjectModel.Collection<VisualGlideSlopeIndicatorTimeSliceTypeExtension> _extension;
        
        [System.Xml.Serialization.XmlElementAttribute("extension")]
        public System.Collections.ObjectModel.Collection<VisualGlideSlopeIndicatorTimeSliceTypeExtension> Extension
        {
            get
            {
