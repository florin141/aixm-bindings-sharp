...
namespace aixm.v5_1_1
{
    ...
    [System.Xml.Serialization.XmlTypeAttribute("TaxiHoldingPositionLightSystemTimeSliceType", Namespace="http://www.aixm.aero/schema/5.1.1")]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlRootAttribute("TaxiHoldingPositionLightSystemTimeSlice", Namespace="http://www.aixm.aero/schema/5.1.1")]
    public partial class TaxiHoldingPositionLightSystemTimeSliceType : aixm.v5_1_1.AbstractAIXMTimeSliceType
    {
        ...
        /// <summary>
        /// <para xml:lang="de">Initialisiert eine neue Instanz der <see cref="TaxiHoldingPositionLightSystemTimeSliceType" /> Klasse.</para>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="TaxiHoldingPositionLightSystemTimeSliceType" /> class.</para>
        /// </summary>
        public TaxiHoldingPositionLightSystemTimeSliceType()
        {
            ...
            this._extension = new System.Collections.ObjectModel.Collection<TaxiHoldingPositionLightSystemTimeSliceTypeExtension>();
        }
        ...
        public aixm.v5_1_1.CodeLightHoldingPositionType Type { get; set; }
        
        [System.Xml.Serialization.XmlElementAttribute("taxiHolding", IsNullable=true)]
        public TaxiHoldingPositionPropertyType TaxiHolding { get; set; }
        
        [System.Xml.Serialization.XmlIgnoreAttribute()]
        private System.Collections.ObjectModel.Collection<TaxiHoldingPositionLightSystemTimeSliceTypeExtension> _extension;
        
        [System.Xml.Serialization.XmlElementAttribute("extension")]
        public System.Collections.ObjectModel.Collection<TaxiHoldingPositionLightSystemTimeSliceTypeExtension> Extension
        {
            get
            {
