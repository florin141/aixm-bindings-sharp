...
namespace aixm.v5_1_1
{
    ...
    [System.Xml.Serialization.XmlTypeAttribute("RoutePortionType", Namespace="http://www.aixm.aero/schema/5.1.1")]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlRootAttribute("RoutePortion", Namespace="http://www.aixm.aero/schema/5.1.1")]
    public partial class RoutePortionType : aixm.v5_1_1.AbstractAIXMObjectType
    {
        ...
        [System.Xml.Serialization.XmlElementAttribute("intermediatePoint_fixDesignatedPoint", IsNullable=true)]
        public DesignatedPointPropertyType IntermediatePoint_FixDesignatedPoint { get; set; }
        
        [System.Xml.Serialization.XmlElementAttribute("intermediatePoint_navaidSystem", IsNullable=true)]
        public NavaidPropertyType IntermediatePoint_NavaidSystem { get; set; }
        
        [System.Xml.Serialization.XmlElementAttribute("intermediatePoint_position", IsNullable=true)]
        public PointPropertyType IntermediatePoint_Position { get; set; }
        
        [System.Xml.Serialization.XmlElementAttribute("intermediatePoint_runwayPoint", IsNullable=true)]
        public RunwayCentrelinePointPropertyType IntermediatePoint_RunwayPoint { get; set; }
        
        [System.Xml.Serialization.XmlElementAttribute("intermediatePoint_aimingPoint", IsNullable=true)]
        public TouchDownLiftOffPropertyType IntermediatePoint_AimingPoint { get; set; }
        
        [System.Xml.Serialization.XmlElementAttribute("intermediatePoint_airportReferencePoint", IsNullable=true)]
        public AirportHeliportPropertyType IntermediatePoint_AirportReferencePoint { get; set; }
        
        [System.Xml.Serialization.XmlElementAttribute("referencedRoute", IsNullable=true)]
        public RoutePropertyType ReferencedRoute { get; set; }
        ...
        /// <summary>
        /// <para xml:lang="de">Initialisiert eine neue Instanz der <see cref="RoutePortionType" /> Klasse.</para>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="RoutePortionType" /> class.</para>
        /// </summary>
        public RoutePortionType()
        {
            this._annotation = new System.Collections.ObjectModel.Collection<NotePropertyType>();
            this._extension = new System.Collections.ObjectModel.Collection<RoutePortionTypeExtension>();
        }
        
        [System.Xml.Serialization.XmlIgnoreAttribute()]
        private System.Collections.ObjectModel.Collection<RoutePortionTypeExtension> _extension;
        
        [System.Xml.Serialization.XmlElementAttribute("extension")]
        public System.Collections.ObjectModel.Collection<RoutePortionTypeExtension> Extension
        {
            get
            {
