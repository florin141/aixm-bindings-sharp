...
namespace aixm.v5_1_1
{
    ...
    [System.Xml.Serialization.XmlTypeAttribute("EnRouteSegmentPointType", Namespace="http://www.aixm.aero/schema/5.1.1")]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlRootAttribute("EnRouteSegmentPoint", Namespace="http://www.aixm.aero/schema/5.1.1")]
    public partial class EnRouteSegmentPointType : AbstractSegmentPointType
    {
        ...
        /// <summary>
        /// <para xml:lang="de">Initialisiert eine neue Instanz der <see cref="EnRouteSegmentPointType" /> Klasse.</para>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="EnRouteSegmentPointType" /> class.</para>
        /// </summary>
        public EnRouteSegmentPointType()
        {
            ...
            this._extension = new System.Collections.ObjectModel.Collection<EnRouteSegmentPointTypeExtension>();
        }
        ...
        [System.Xml.Serialization.XmlElementAttribute("roleFreeFlight", IsNullable=true)]
        public aixm.v5_1_1.CodeFreeFlightType RoleFreeFlight { get; set; }
        
        [System.Xml.Serialization.XmlElementAttribute("roleRVSM", IsNullable=true)]
        public aixm.v5_1_1.CodeRVSMPointRoleType RoleRVSM { get; set; }
        
        [System.Xml.Serialization.XmlElementAttribute("turnRadius", IsNullable=true)]
        public aixm.v5_1_1.ValDistanceType TurnRadius { get; set; }
        
        [System.Xml.Serialization.XmlElementAttribute("roleMilitaryTraining", IsNullable=true)]
        public aixm.v5_1_1.CodeMilitaryRoutePointType RoleMilitaryTraining { get; set; }
        
        [System.Xml.Serialization.XmlIgnoreAttribute()]
        private System.Collections.ObjectModel.Collection<EnRouteSegmentPointTypeExtension> _extension;
        
        [System.Xml.Serialization.XmlElementAttribute("extension")]
        public System.Collections.ObjectModel.Collection<EnRouteSegmentPointTypeExtension> Extension
        {
            get
            {
