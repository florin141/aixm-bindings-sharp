...
namespace aixm.v5_1_1
{
    ...
    [System.Xml.Serialization.XmlTypeAttribute("ApproachLightingSystemTimeSliceType", Namespace="http://www.aixm.aero/schema/5.1.1")]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlRootAttribute("ApproachLightingSystemTimeSlice", Namespace="http://www.aixm.aero/schema/5.1.1")]
    public partial class ApproachLightingSystemTimeSliceType : aixm.v5_1_1.AbstractAIXMTimeSliceType
    {
        ...
        /// <summary>
        /// <para xml:lang="de">Initialisiert eine neue Instanz der <see cref="ApproachLightingSystemTimeSliceType" /> Klasse.</para>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="ApproachLightingSystemTimeSliceType" /> class.</para>
        /// </summary>
        public ApproachLightingSystemTimeSliceType()
        {
            ...
            this._extension = new System.Collections.ObjectModel.Collection<ApproachLightingSystemTimeSliceTypeExtension>();
        }
        ...
        [System.Xml.Serialization.XmlElementAttribute("classICAO", IsNullable=true)]
        public aixm.v5_1_1.CodeApproachLightingICAOType ClassICAO { get; set; }
        
        [System.Xml.Serialization.XmlElementAttribute("type", IsNullable=true)]
        public aixm.v5_1_1.CodeApproachLightingType Type { get; set; }
        
        [System.Xml.Serialization.XmlElementAttribute("length", IsNullable=true)]
        public aixm.v5_1_1.ValDistanceType Length { get; set; }
        
        [System.Xml.Serialization.XmlElementAttribute("sequencedFlashing", IsNullable=true)]
        public aixm.v5_1_1.CodeYesNoType SequencedFlashing { get; set; }
        
        [System.Xml.Serialization.XmlElementAttribute("alignmentIndicator", IsNullable=true)]
        public aixm.v5_1_1.CodeYesNoType AlignmentIndicator { get; set; }
        
        [System.Xml.Serialization.XmlElementAttribute("servedRunwayDirection", IsNullable=true)]
        public RunwayDirectionPropertyType ServedRunwayDirection { get; set; }
        
        [System.Xml.Serialization.XmlIgnoreAttribute()]
        private System.Collections.ObjectModel.Collection<ApproachLightingSystemTimeSliceTypeExtension> _extension;
        
        [System.Xml.Serialization.XmlElementAttribute("extension")]
        public System.Collections.ObjectModel.Collection<ApproachLightingSystemTimeSliceTypeExtension> Extension
        {
            get
            {
