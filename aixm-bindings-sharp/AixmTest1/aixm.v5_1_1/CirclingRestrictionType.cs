...
namespace aixm.v5_1_1
{
    ...
    [System.Xml.Serialization.XmlTypeAttribute("CirclingRestrictionType", Namespace="http://www.aixm.aero/schema/5.1.1")]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlRootAttribute("CirclingRestriction", Namespace="http://www.aixm.aero/schema/5.1.1")]
    public partial class CirclingRestrictionType : AbstractPropertiesWithScheduleType
    {
        ...
        /// <summary>
        /// <para xml:lang="de">Initialisiert eine neue Instanz der <see cref="CirclingRestrictionType" /> Klasse.</para>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="CirclingRestrictionType" /> class.</para>
        /// </summary>
        public CirclingRestrictionType()
        {
            ...
            this._extension = new System.Collections.ObjectModel.Collection<CirclingRestrictionTypeExtension>();
        }
        ...
        [System.Xml.Serialization.XmlElementAttribute("sectorDescription", IsNullable=true)]
        public CircleSectorPropertyType SectorDescription { get; set; }
        
        [System.Xml.Serialization.XmlElementAttribute("restrictionArea", IsNullable=true)]
        public SurfacePropertyType RestrictionArea { get; set; }
        
        [System.Xml.Serialization.XmlIgnoreAttribute()]
        private System.Collections.ObjectModel.Collection<CirclingRestrictionTypeExtension> _extension;
        
        [System.Xml.Serialization.XmlElementAttribute("extension")]
        public System.Collections.ObjectModel.Collection<CirclingRestrictionTypeExtension> Extension
        {
            get
            {
