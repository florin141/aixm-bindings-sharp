...
namespace aixm.v5_1_1
{
    ...
    [System.Xml.Serialization.XmlTypeAttribute("MarkingBuoyTimeSliceType", Namespace="http://www.aixm.aero/schema/5.1.1")]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlRootAttribute("MarkingBuoyTimeSlice", Namespace="http://www.aixm.aero/schema/5.1.1")]
    public partial class MarkingBuoyTimeSliceType : aixm.v5_1_1.AbstractAIXMTimeSliceType
    {
        
        [System.Xml.Serialization.XmlElementAttribute("designator", IsNullable=true)]
        public aixm.v5_1_1.CodeBuoyDesignatorType Designator { get; set; }
        
        [System.Xml.Serialization.XmlElementAttribute("type", IsNullable=true)]
        public aixm.v5_1_1.CodeBuoyType Type { get; set; }
        
        [System.Xml.Serialization.XmlElementAttribute("colour", IsNullable=true)]
        public aixm.v5_1_1.CodeColourType Colour { get; set; }
        
        [System.Xml.Serialization.XmlElementAttribute("theSeaplaneLandingArea", IsNullable=true)]
        public SeaplaneLandingAreaPropertyType TheSeaplaneLandingArea { get; set; }
        ...
        /// <summary>
        /// <para xml:lang="de">Initialisiert eine neue Instanz der <see cref="MarkingBuoyTimeSliceType" /> Klasse.</para>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="MarkingBuoyTimeSliceType" /> class.</para>
        /// </summary>
        public MarkingBuoyTimeSliceType()
        {
            this._annotation = new System.Collections.ObjectModel.Collection<NotePropertyType>();
            this._extension = new System.Collections.ObjectModel.Collection<MarkingBuoyTimeSliceTypeExtension>();
        }
        
        [System.Xml.Serialization.XmlIgnoreAttribute()]
        private System.Collections.ObjectModel.Collection<MarkingBuoyTimeSliceTypeExtension> _extension;
        
        [System.Xml.Serialization.XmlElementAttribute("extension")]
        public System.Collections.ObjectModel.Collection<MarkingBuoyTimeSliceTypeExtension> Extension
        {
            get
            {
